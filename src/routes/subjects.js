    ...
    const subjects = [
      {
        ...
        image: 'https://cdn.pixabay.com/photo/2016/02/19/11/19/math-1209810_960_720.jpg'
      },
      {
        id: 2,
        name: 'Science',
        ...
        image: 'https://cdn.pixabay.com/photo/2017/08/10/07/32/science-2614388_960_720.jpg'
      },
      {
        id: 3,
        name: 'English',
      ...
      },
      {
        id: 4,
        name: 'History',
        description: 'History is the study of the past as it is narrated in written documents. Events occurring before written record are considered prehistory.',
      ...
      },
      {
        ...
        description: 'Physical education, also known as Phys Ed., PE, gym, or gym class, and in some Commonwealth countries as physical training or PT, is a class that pupils are required to take at school.',
        image: 'https://cdn.pixabay.com/photo/2016/11/29/05/45/astronomy-1867616_960_720.jpg'
      }]
    res.send(subjects)
  })
